  ...
  return (
    <section id="contact" className="py-24 px-6">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
        <div>
          <span className="text-cyan text-sm font-medium uppercase tracking-widest">Contact</span>
          <h2 className="mt-3 text-4xl md:text-5xl font-bold">Let's build a <span className="text-gradient">healthier future</span></h2>
