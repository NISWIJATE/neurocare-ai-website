  ...
  return (
    <section id="about" className="section-pad">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 md:gap-16 items-center">
        <Reveal>
          <span className="text-cyan text-xs sm:text-sm font-medium uppercase tracking-widest">About Us</span>
        ...
        <Reveal delay={150}>
          <div className="relative">
            ...
            <div className="relative glass rounded-3xl p-6 sm:p-8 animate-float">
